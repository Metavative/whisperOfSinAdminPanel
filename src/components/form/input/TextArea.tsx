"use client"; // Ensure this is present if this component is used in client-side contexts
...
interface TextareaProps {
  ...
  onChange?: (value: string) => void; // Change handler (sends updates to parent)
...
const TextArea: React.FC<TextareaProps> = ({
  ...
  value = "", // Default value for the prop if not provided (ensures it's always controlled)
  ...
  const handleChange = (e: React.ChangeEvent<HTMLTextAreaElement>) => {
    if (onChange) {
      onChange(e.target.value); // Pass the new value up to the parent component
    }
  };
  ...
  return (
    <div className="relative">
      <textarea
        ...
        rows={rows}
        value={value} // This is where the magic happens: the input's value is controlled by the 'value' prop
